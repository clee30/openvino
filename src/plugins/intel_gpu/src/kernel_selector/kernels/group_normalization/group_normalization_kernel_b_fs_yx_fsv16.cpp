...
void GroupNormalizationKernel_b_fs_yx_fsv16::GetUpdateDispatchDataFunc(KernelData& kd) const {
    kd.update_dispatch_data_func = [this](const Params& params, KernelData& kd) {
        ...
        kd.kernels[1].params.workGroups.global = dispatchData.stage_final.gws;
        kd.kernels[1].params.workGroups.local = dispatchData.stage_final.lws;
        kd.kernels[1].skip_execution = KernelData::SkipKernelExecution(prim_params, 4);
...
KernelsData GroupNormalizationKernel_b_fs_yx_fsv16::GetKernelsData(const Params &params) const {
    ...
    KernelData kd = KernelData::Default<group_normalization_params>(params, 2);
