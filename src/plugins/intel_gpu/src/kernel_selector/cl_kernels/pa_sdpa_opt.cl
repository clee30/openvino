...
#if K_HEAD_SIZE > 128 || HEADS_PER_WI > 1
...
KERNEL(pa_sdpa_opt)(
    ...
    // rotation_trig_lut [MAX_CONTEXT_LEN, V_HEAD_SIZE]
    //
    // Output shapes:
...
//    const uint head_size_idx = lid % K_HEAD_SIZE;
...

    {
        ...
        if ((partition_seq_len > (SEQ_LEN_PARTITION_SIZE / SG_SCALE_FACTOR)) || (leftovers != 0)) {
            ...
            //chonming  K_HEAD_SIZE or V_HEAD_SIZE seem ok
...
//    if (get_global_linear_id() == 0)
//        printf("in pa_sdpa_finalization_stage\n");
